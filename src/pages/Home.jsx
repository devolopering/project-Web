  ...
  <div className='max-w-[1261px] mx-auto flex justify-between gap-[94px] mt-14 mb-[151px]'>
    ...
    <div className='grid grid-cols-2 gap-[33px] w-full'>
      ...
      <img src={contact2} alt="contact2" />
        <h3 className='font-sf-pro-display font-bold  text-[31px] mt-[25px] mb-4 text-white '>Phone</h3>
        <p className='font-sf-pro-display font-medium text-[21px] text-white'>+1-800-555-1234</p>
      </div>
      <div className='flex flex-col items-start'>
      <img src={contact3} alt="contact3" />
        <h3 className='font-sf-pro-display font-bold  text-[31px] mt-6 mb-4 text-white '>Office</h3>
        <p className='font-sf-pro-display font-medium text-[21px] text-white'>123 Logistics Ave, <br /> Dallas, TX 75001</p>
      </div>
      <div className='flex flex-col items-start'>
        <img src={contact4} alt="contact4" />
        <h3 className='font-sf-pro-display font-bold  text-[31px] mt-[25px] mb-4 text-white '>Socials</h3>
